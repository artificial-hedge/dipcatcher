...
SYMS: list[str] = [
    # broad + sector ETFs
    "SPY", "QQQ", "IWM", "DIA", "XLF", "XLE", "XLK", "XLV", "XLP", "XLU",
    "XLI", "XLB", "XLY", "XLRE", "TLT", "IEF", "SHY", "LQD", "HYG", "TIP",
    "GLD", "SLV", "USO", "UNG", "UUP", "FXE", "FXY", "EEM", "EFA", "VNQ",
    "SVXY", "VXX",
    # liquid megacap stocks
    "AAPL", "MSFT", "NVDA", "AMZN", "GOOGL", "META", "TSLA", "AVGO",
    "JPM", "V", "MA", "XOM", "CVX", "UNH", "HD", "PG", "KO", "PEP",
    "COST", "WMT", "MCD", "CRM", "AMD", "INTC", "NFLX", "DIS", "BA",
    "CAT", "GE", "HON", "UPS", "GS", "MS", "BAC", "C", "WFC", "T",
    "VZ", "PFE", "MRK", "ABT", "LLY", "JNJ", "ORCL", "IBM", "QCOM",
    "TXN", "ADBE", "NOW", "PANW", "CSCO", "MU", "F", "GM", "DE",
]
