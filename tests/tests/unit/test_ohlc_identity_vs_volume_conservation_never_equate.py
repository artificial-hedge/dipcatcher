"""ohlc_identity_rate ≠ session_volume_conservation_rate — never-equate (H20 ≠ H24)."""
...
def test_keys_gates_and_h24_bind() -> None:
    assert "ohlc_identity_rate" != "session_volume_conservation_rate"
    assert H20_HYPOTHESIS_ID != H24_HYPOTHESIS_ID
...
def test_synth_both_stamped_never_equate_clean() -> None:
    ...
    assert ohlc_identity_vs_volume_conservation_never_equate_honesty_errors(receipt) == []
