...
| 2 | Net-return tournament | Pending. Reuse frozen dates and eligible universe, compare benchmark/candidates under identical sizing and execution assumptions, record every trial, account for fees/spread/impact/borrow/financing, and apply dependence-aware multiple-testing comparisons. Complete the causal-liquidity PR #28 integration before using next-open results. |
