...
_NEED_KEYWORDS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("enterprise", ("工商", "企业信息", "失信", "registry", "天眼查", "enterprise")),
    ("research", ("研报", "research report", "analyst", "晨会", "路演", "roadshow", "券商观点")),
    (
        "filings",
        ("公告", "年报", "季报", "招股", "10-k", "10-q", "8-k", "filing", "披露", "announcement"),
    ),
    ...
    ("quote", ("行情", "价格", "quote", "price", "k线", "kline", "股价", "市值")),
]
...
_MARKET_PATTERNS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("us", ("美股", "纳斯达克", "纽交所", "us stock", ".o", ".n", "adr", "标普", "sp500")),
]
    ...
    *,
    ...
    for candidate in sorted(plan.candidates, key=lambda c: c.rank):
        ...
        if not candidate.usable:
            attempts.append(f"{candidate.source}: skipped ({probe.status} — {probe.detail})")
            continue
